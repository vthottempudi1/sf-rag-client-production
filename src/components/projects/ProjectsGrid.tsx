      ...
      <div className="border-b border-gray-800/50 bg-[#0f0f0f]/95 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-medium text-white tracking-tight">Projects</h1>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center bg-gray-900/50 border border-gray-800 rounded-lg p-1">
                <button
                  ...
                  className={`p-1.5 rounded transition-all duration-200 ${viewMode === "grid" ? "bg-gray-700 text-white" : "text-gray-500 hover:text-gray-300"}`}
                >
                  <Grid3X3 size={16} />
                </button>
                <button
                  onClick={() => onViewModeChange("list")}
                  className={`p-1.5 rounded transition-all duration-200 ${viewMode === "list" ? "bg-gray-700 text-white" : "text-gray-500 hover:text-gray-300"}`}
                >
                  <List size={16} />
                </button>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {projects.length === 0 ? (
          <div className="text-center py-20">
            {searchQuery ? (
              ...
              <div className="max-w-md mx-auto">
                ...
                <h3 className="text-xl font-medium text-white mb-3">No projects found</h3>
                <p className="text-gray-400 mb-6">Try adjusting your search terms or create a new project</p>
                <button
              ...
              <div className="max-w-md mx-auto">
                ...
                <h3 className="text-2xl font-medium text-white mb-3">Create your first project</h3>
                <p className="text-gray-400 mb-8 leading-relaxed">Projects help you organize your documents and conversations. Start by creating your first project.</p>
                <button
                  onClick={onCreateProject}
          ...
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-lg font-medium text-gray-300 mb-4">Recent projects</h2>
              {viewMode === "grid" ? (
                  ...
                  {projects.map((project) => (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <h3 className="font-medium text-white text-base line-clamp-2 group-hover:text-gray-100 transition-colors">{project.name}</h3>
                        {project.description && (
                  ...
                  {projects.map((project) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium text-white truncate group-hover:text-gray-100 transition-colors">{project.name}</h3>
                        {project.description && (
                          <p className="text-gray-400 text-sm truncate mt-1">{project.description}</p>
                        )}
                      </div>
                      {/* Date */}
                      <div className="text-xs text-gray-500 flex-shrink-0 self-start">{new Date(project.created_at).toLocaleDateString()}</div>
                      {/* Delete Button */}
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
