                        ...
                        <div className="grid gap-2">
                          {message.citations.map((citation, citationIndex) => (
                            <button
                              ...
                              className="flex items-center gap-3 bg-[#252525] hover:bg-[#2a2a2a] rounded-lg px-3 py-2 border border-gray-700 hover:border-gray-600 transition-colors text-left"
                            >
                              {/* Document Icon */}
